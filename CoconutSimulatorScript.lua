local library = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Squex01/CoconutSimulatorScript/main/CoconutSimulator.lua')))()
    ...
    spawn(function()
        pcall(function()
            if ClickTreeOutSide == true then
                for i,v in pairs(game:GetService("Workspace").TreeSpawners:GetDescendants()) do
